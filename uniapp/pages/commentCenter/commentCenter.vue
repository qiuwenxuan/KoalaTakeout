	...
	<view style="padding: 20rpx">
		<view class="box">
			<view v-for="item in commentList" :key="item.id" style="border-bottom: 2rpx solid #eee; padding: 20rpx 0">
				<navigator :url="'/pages/detail/detail?businessId=' + item.businessId" style="font-size: 34rpx; display: inline-block; margin-bottom: 10rpx">
					{{ item.businessName }}
					<uni-icons type="right" size="18" color="#888" style="position: relative; top: 2rpx"></uni-icons>
				</navigator>
